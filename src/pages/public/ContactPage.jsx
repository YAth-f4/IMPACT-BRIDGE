...
export default function ContactPage() {
  const { sendMessage, ngoProfile, addToast } = useApp();
  ...
  const faqs = [
    {
      ...
      a: 'Immediately after donating, you can download your official 80G Tax Exemption Certificate (Form 10BE compliant) with your PAN card number embedded. We also file annual Form 10BD with the Income Tax Department.'
    },
    {
  ...
  return (
    <div className="contact-page" style={{ display: 'flex', flexDirection: 'column', gap: '3.5rem' }}>
      {/* 1. HERO HEADER */}
      <section
        style={{
          padding: '3rem 0',
