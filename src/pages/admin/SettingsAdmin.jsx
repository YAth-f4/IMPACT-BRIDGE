...
export default function SettingsAdmin() {
  ...
  const [activeTab, setActiveTab] = useState('organization'); // 'organization' | 'staff' | 'notifications' | 'data'
  ...
  return (
    <div className="settings-admin" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      {/* 1. TOP HEADER */}
