...
export default function MessagesAdmin() {
  ...
  const [activeFolder, setActiveFolder] = useState('All'); // 'All' | 'Volunteers' | 'Donors' | 'Contact Form' | 'Starred'
  ...
  return (
    <div className="messages-admin" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      {/* 1. TOP HEADER */}
