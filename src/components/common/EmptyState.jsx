    ...
    >
      <div style={{ marginBottom: '1.25rem' }}>
        {icon ? (
          ...
          <Mascot variant="curious" size={80} animate={true} />
        )}
      </div>
...
export function LoadingState({ message = 'Loading records...' }) {
  return (
    ...
    >
      <Mascot variant="builder" size={70} animate={true} />
      <div
        style={{
          width: '36px',
          height: '36px',
      ...
      />
      <p style={{ fontFamily: 'var(--font-heading)', fontWeight: 800, fontSize: '1rem', color: 'var(--text-dark)' }}>
        {message}
      </p>
      <style>{`
        @keyframes spin {
