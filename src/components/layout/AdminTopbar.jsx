...
export default function AdminTopbar({ setMobileOpen }) {
  ...
  const viewTitles = {
    ...
    '/admin/requests/find-help': 'Find Help Requests',
    '/admin/requests/fund-raise': 'Fund Raise Requests',
    '/admin/requests/volunteers': 'Volunteer Applications',
    '/admin/ngo-registrations': 'NGO Registration Review',
    '/admin/users': 'Users & Role Management',
    '/admin/users-and-roles': 'Users & Role Management',
    '/admin/volunteers': 'Volunteer Management',
    '/admin/beneficiaries': 'Beneficiary Management',
    '/admin/donations': 'Donation Ledger & Analytics',
    '/admin/programs': 'Programs & Operations',
